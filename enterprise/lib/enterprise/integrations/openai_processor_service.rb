module Enterprise::Integrations::OpenaiProcessorService
  ALLOWED_EVENT_NAMES = %w[rephrase summarize reply_suggestion label_suggestion conversation_analysis
                           fix_spelling_grammar shorten expand make_friendly make_formal simplify].freeze
