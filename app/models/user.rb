...
class User < ApplicationRecord
  ...
  has_many :routine_completions, dependent: :destroy_async
  ...
  has_many :analyzed_calls, class_name: 'CallAnalysis', foreign_key: 'user_id', dependent: :destroy_async, inverse_of: :user
  has_many :created_call_analyses, class_name: 'CallAnalysis', foreign_key: 'created_by_id', dependent: :nullify, inverse_of: :created_by
  has_one :seller_pdi, dependent: :destroy_async
